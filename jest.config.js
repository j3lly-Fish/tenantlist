module.exports = {
  ...
  testPathIgnorePatterns: ['/node_modules/', '/tenantlist/'],
  collectCoverageFrom: [
    'src/**/*.ts',
    'src/**/*.tsx',
    '!src/**/*.test.ts',
  ...
  projects: [
    ...
    },
    {
      ...
      moduleNameMapper: {
        ...
        '^@frontend/services/propertyPollingService$': '<rootDir>/src/frontend/__mocks__/propertyPollingService.ts',
        ...
        '^@utils/env$': '<rootDir>/src/frontend/__mocks__/env.ts',
